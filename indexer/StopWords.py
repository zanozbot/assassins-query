...
swds = set()
try:
        swds |= stopwords.words("slovene")
except:
        print("Default word configuration not found")

stop_words_slovene = swds.union(set(
        ["ter", "nov", "novo", "nova", "zato", "še", "zaradi", "a", "ali", "april", "avgust", "b", "bi", "bil", "bila", "bile", "bili", "bilo", "biti",
         ...
         "svoj", "jesti", "imeti", "iti", "kak", "www", "km", "eur", "pač", "del", "kljub", "šele", "prek",
